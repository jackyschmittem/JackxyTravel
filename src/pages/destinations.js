...
import imgDubai from '../images/Dubai/ueberseite.jpg';
import imgHongKong from '../images/HongKong/ueberseiteneu.jpg';
import imgFrance from '../images/Frankreich/promenade.jpg';
import imgOslo from '../images/Oslo/ueberseite.jpg';
import imgMalta from '../images/Malta/ueberseite.jpg';
			...
			<Figure>
				<Flex flexWrap="wrap">
					...
					<Box width={[1, 1 / 2]} pl={[0, 2]}>
						<Link to="./hongkong/">
							<div class="container">
								<img src={imgHongKong} width="600" alt="HongKong" float="left" />
								<div class="overlay">
				...
				<Flex flexWrap="wrap">
					...
					<Box width={[1, 1 / 2]} pl={[0, 2]}>
						<Link to="./frenchriviera/">
							<div class="container">
								<img src={imgFrance} width="600" alt="French Riviera" float="left" />
								<div class="overlay">
