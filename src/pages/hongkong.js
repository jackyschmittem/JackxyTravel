...
const HongKongPage = () => (
  <Layout>
    ...
    <Section>
      ...
      <RespGrid min={"240px"}>
        <P>
          Hong Kong is on of the most impressive cities of the world. Just as
          it's two parts (Hong Kong island and mainland), the metropolis offers
          travellers a perfect mixture of the traditional Asian culture and a
          more "western" styled Hong Kong (Island). Having said this, Hong Kong
          and it's stunning culture are the perfect destination to start with
          when exploring Asia. Both, the island and the mainland, can be easily
          explored by tram, metro or foot as the different "hot spots" are most
          of the time nearby.
        </P>
        <P>
          ...
          yourself. You want to know more about Hong Kong? Don't hesitate to{" "}
