...
const BookingPage = () => (
	<Layout>
		...
		<Section>
			<Figure>
				<img src={imgA} width="100%" height="100%" alt="Malta Ocean" float="left" />
			</Figure>
			<Section />
			...
			<RespGrid min={'240px'}>
				<P>
					We are very sorry, but as we are keen to realise highly individual holidays, we only work on
					request. Our travel consultants will have detailed conversations with you, making sure everything
					will turn out just as you wish it to be. Unfortunately, we cannot guarantee our best service by
					having fixed packages being bookable online.
				</P>
				<P>
